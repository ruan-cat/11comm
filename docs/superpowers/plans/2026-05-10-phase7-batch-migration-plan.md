...
| 维度                                                | 当前口径                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Admin 旧 API                                        | 当前 working tree 口径：`apps/admin/server/api/**/*.ts` 共 155 个旧 API 文件；`apps/api/server/routes/api/**/*.ts` 共 160 个 server route；exact legacy path 已覆盖 155/155。2026-05-18 已补 `property-manage/report-manage/expense-summary-table/list.post.ts`，并以 fee module 独立 report 语义链路 `listReportExpenseSummaryTables` 读取 `rptExpenseSummaries`，没有 alias 到 `expense-manage/listExpenseSummaryTables` 或 `exExpenseSummaryTables`。P1 四个 `report-manage` 端点已在 staged working tree 接线，并已补本地语义验收和 `/api-shadow` 页面 Network；但仍缺生产 `DB_READY`、真实库样本复核、shadow-off/fallback 页面演练，不能写成完成或旧服务可退役                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Admin 前端切流                                      | **2026-05-18 admin 前端 resolver 迁移已全部完成。** `apps/admin/src/api/**/index.ts` 中不再保留 `report-manage/expense-summary-table/list` 路径冲突硬编码项；该 hook 已接入 `resolveAdminApiRequestUrl`。最终批次覆盖 7 个域 34 个 hook：`community-manage`(7)、`house-property-manage`(9)、`contract-manage`(11)、`repairs-manage`(4)、`dev-team/menu-manage`(3)、`dev-team/cache-manage`(1)、`setting-manage/organize-manage`(2)；6 files / 108 tests passed，admin typecheck 通过。此前已完成：`operation-team` 13 个、`expense-manage` 14 个、`setting-manage/system-manage` 5 个、`dev-team/config-manage` 4 个、`report-manage` 系列、`patrol-manage`、`parking-manage` 等。final batch 44/44 和 shadow-off/fallback 仍只按本地页面/代理证据记录；不得写成生产 `DB_READY` 或旧服务可退役。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| 2026-05-18 report expense-summary 页面补证          | 已用 fresh `apps/api` 3103 + `apps/admin` 8080 通过 Chrome MCP 验证 `property-manage/report-manage/expense-summary-table` 页面：页面真实请求 `/api-shadow/api/property-manage/report-manage/expense-summary-table/list` 返回 200、`x-api-phase=phase3-infra`、`total=2`，表格显示 `物业费`、`停车费` 和应收/实收/收缴率字段。该证据只覆盖本地 shadow/browser evidence，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback 或旧服务可退役                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 2026-05-18 report-manage 剩余页面补证               | 已用同一组 fresh `apps/api` 3103 + `apps/admin` 8080 通过 Chrome MCP 验证 P1 `report-manage` 剩余 7 个页面：`arrears-details-list`、`data-statistics`、`deposit-report`、`fee-reminder`、`no-charge-house`、`outstanding-fees-analysis`、`patrol-report`。这些页面均由真实页面组件发出 `/api-shadow/api/property-manage/report-manage/**/list` 请求，返回 200、`x-api-phase=phase3-infra`、`success=true`；admin 控制台仅有既有 Vue Router `next()` deprecation warning，无 target page console error。证据文件：`.tmp/phase7-dev-browser/2026-05-18-report-manage-remaining-page-network-verification.md`。该证据只覆盖本地 shadow/browser evidence，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback 或旧服务可退役                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 2026-05-19 operation-team manifest/HTTP gate        | 已补齐 `operation-team` 13 个 admin list old path 的 `apps/api` runtime manifest / contract / HTTP gate 护栏：`runtime-endpoints.ts` 统一登记为 `targetClient=admin`、`routeKind=admin-canonical`、`responseContract=JsonVO`、`ownerModule=operation`、`cutoverStatus=available-in-apps-api-not-caller-verified`；infra manifest/contract tests 与 fetch 型 gated HTTP POST test 显式覆盖 13 个 endpoint。验证：目标 Vitest 3 files / 12 tests passed；fresh `apps/api` 3114 gated HTTP 1 file / 7 tests passed；api typecheck 与 diff check 通过。该证据只覆盖本地 manifest/contract/HTTP gate，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback 或旧服务可退役                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 2026-05-19 patrol/parking manifest/HTTP gate        | 已补齐 `patrol-manage` 6 个与 `parking-manage` 4 个 admin list old path 的 `apps/api` runtime manifest / contract / HTTP gate 护栏：`runtime-endpoints.ts` 统一登记为 `targetClient=admin`、`routeKind=admin-canonical`、`responseContract=JsonVO`、`ownerModule=patrol                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | parking`、`cutoverStatus=available-in-apps-api-not-caller-verified`；infra manifest/contract tests 与 fetch 型 gated HTTP POST test 显式覆盖 10 个 endpoint。验证：目标 Vitest 3 files / 12 tests passed；fresh`apps/api`3115 gated HTTP 1 file / 8 tests passed；api typecheck 与 cached diff check 通过。该证据只覆盖本地 manifest/contract/HTTP gate，不代表生产`DB_READY`、真实库样本、shadow-off/fallback、真实页面 CRUD/交互或旧服务可退役 |
| 2026-05-19 expense-manage manifest/HTTP gate        | 已补齐 `property-manage/expense-manage` 14 个 admin list old path 的 `apps/api` runtime manifest / contract / HTTP gate 护栏：`runtime-endpoints.ts` 统一登记为 `targetClient=admin`、`routeKind=admin-canonical`、`responseContract=JsonVO`、`ownerModule=fee`、`cutoverStatus=available-in-apps-api-not-caller-verified`；infra manifest/contract tests 与 fetch 型 gated HTTP POST test 显式覆盖 14 个 endpoint。验证：目标 Vitest 3 files / 12 tests passed；fresh `apps/api` 3116 gated HTTP 1 file / 9 tests passed；api typecheck 与 cached diff check 通过。该证据只覆盖本地 manifest/contract/HTTP gate，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback、真实页面 CRUD/交互或旧服务可退役                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 2026-05-19 report-manage manifest/HTTP gate         | 已补齐 `property-manage/report-manage` 12 个只读 admin canonical list old path 的 `apps/api` runtime manifest / contract / HTTP gate 护栏：`runtime-endpoints.ts` 统一登记为 `targetClient=admin`、`routeKind=admin-canonical`、`responseContract=JsonVO`、`ownerModule=fee-report`、`cutoverStatus=available-in-apps-api-not-caller-verified`；infra manifest/contract tests 与 fetch 型 gated HTTP POST test 已显式覆盖这 12 个 endpoint。验证：目标 Vitest 3 files / 12 tests passed；fresh `apps/api` 3117 gated HTTP 1 file / 10 tests passed；api typecheck 与 cached diff check 通过。当前只完成本地 runtime manifest/contract/HTTP gate 增量护栏；仍缺生产 `DB_READY`、真实库样本复核、shadow-off/fallback、真实页面 CRUD/交互和旧服务退役证据。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 2026-05-19 community-manage manifest/HTTP gate      | 已补齐 `property-manage/community-manage` 7 个 admin list old path 的 `apps/api` runtime manifest / contract / HTTP gate 护栏：`runtime-endpoints.ts` 统一登记为 `targetClient=admin`、`routeKind=admin-canonical`、`responseContract=JsonVO`、`ownerModule=community`、`cutoverStatus=available-in-apps-api-not-caller-verified`；infra manifest/contract tests 与 fetch 型 gated HTTP POST test 已显式覆盖这 7 个 endpoint。验证：目标 Vitest 3 files / 12 tests passed；fresh `apps/api` 3118 gated HTTP 1 file / 11 tests passed；api typecheck 与 diff check 通过；复核子代理确认无缺漏、未改业务 handler/旧服务目录。当前只完成本地 runtime manifest/contract/HTTP gate 增量护栏；仍缺生产 `DB_READY`、真实库样本复核、shadow-off/fallback、真实页面 CRUD/交互和旧服务退役证据。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 2026-05-19 house-property-manage manifest/HTTP gate | 已补齐 `property-manage/house-property-manage` 10 个 admin list old path 的 `apps/api` runtime manifest / contract / HTTP gate 护栏：`runtime-endpoints.ts` 统一登记为 `targetClient=admin`、`routeKind=admin-canonical`、`responseContract=JsonVO`、`ownerModule=house-property`、`cutoverStatus=available-in-apps-api-not-caller-verified`；infra manifest/contract tests 与 fetch 型 gated HTTP POST test 已显式覆盖这 10 个 endpoint，并补齐 `phase7-house-property-manage-admin-list` 断言。验证：目标 Vitest 3 files / 12 tests passed；fresh `apps/api` 3119 gated HTTP 1 file / 12 tests passed；api typecheck 与 diff check 通过；复核子代理确认 `phase` 断言已补且无语义破坏。当前只完成本地 runtime manifest/contract/HTTP gate 增量护栏；仍缺生产 `DB_READY`、真实库样本复核、shadow-off/fallback、真实页面 CRUD/交互和旧服务退役证据。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 2026-05-19 中断接力状态                             | 用户要求准备中断后已停止继续扩展新切片，`contract-manage` 编辑子代理已关闭且未落盘任何 contract 变更。主控只读扫描确认 `property-manage/contract-manage` 12 个普通 list endpoint 仍缺 runtime manifest/contract/HTTP gate：`archive/list`、`attachment/list`、`clause/list`、`change/list`、`draft-contract/list`、`expire/list`、`first-party/list`、`print/list`、`review/list`、`second-party/list`、`template/list`、`type/list`。下一轮建议只补这 12 个 list；`upload/{init,sign-part,complete,status,abort}`、`change/{create,update,delete,detail}`、`draft-contract/{create,update,delete,detail}` 继续保持排除并单独评审。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| DB 实现                                             | fee 模块 DB 覆盖约 50%；repair 模块已完成只读首切片 DB repository wired，且 2026-05-18 已补 `/app/ownerRepair.listOwnerRepairs`、`/app/dict.queryRepairStates`、`/app/ownerRepair.queryOwnerRepair` 的本地 App H5 页面上下文 Network 证据；但仍非生产 `DB_READY`，写入口保持 guard，`/app/repairSetting.listRepairSettings` 仍缺 App H5 页面证据；admin 已迁移端点均标注 `db-read-repository-wired`，但缺生产 DB_READY、真实库样本与 shadow-off/fallback 证据                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- admin 旧 API 必须区分数字口径：当前 working tree 中 `apps/admin/server/api/**/*.ts` 共 155，`apps/api/server/routes/api/**/*.ts` 共 160，admin old path exact coverage 为 155/155。160 个 route 不能直接等同 160 个可退役旧 path；canonical-only、staged-but-unverified、fallback/guard、缺生产证据的候选路由都必须逐项标注。
...
- [x] 2026-05-18 二次同步确认：`report-manage/expense-summary-table/index.ts` 已接入 `resolveAdminApiRequestUrl`；`apps/api` 已补 `property-manage/report-manage/expense-summary-table/list.post.ts`，不再保留路径冲突硬编码项。admin 前端 resolver 迁移至此全部完成。
...
- [x] 2026-05-18 补齐 admin repair manifest/contract/HTTP gate 证据：`runtime-endpoints.ts` 新增 `repairs-have-done/list`、`return-visit/list`、`phone-report-repairs/list`、`mandatory-return-issue/list` 四个 admin canonical manifest 条目，`repairs-manage` 7 个 admin list old path 已全部进入运行时 manifest。目标 Vitest `tests/admin/repair-admin-endpoints.test.ts tests/infra/endpoint-manifest.test.ts tests/infra/phase7-api-contracts.test.ts` 通过，3 files / 12 tests passed；fresh `apps/api` 3112 上 `RUN_PHASE7_HTTP_TESTS=1 PHASE7_API_BASE_URL=http://127.0.0.1:3112 pnpm -F @01s-11comm/api exec vitest run tests/http/phase7-gated-http.test.ts` 通过，1 file / 6 tests passed；`pnpm -F @01s-11comm/api run typecheck` 和 `git diff --check` 通过。该证据只覆盖本地 manifest/contract/HTTP gate，不得升级为生产 `DB_READY`、真实页面 CRUD 交互、shadow-off/fallback 或旧服务退役证据。
- [x] 2026-05-19 补齐 `operation-team` 13 个 admin list endpoint 的 runtime manifest/contract/HTTP gate 护栏：`runtime-endpoints.ts` 新增 13 个 admin canonical manifest 条目，`tests/infra/endpoint-manifest.test.ts`、`tests/infra/phase7-api-contracts.test.ts` 和 `tests/http/phase7-gated-http.test.ts` 均显式覆盖。fresh `apps/api` 3114 gated HTTP 1 file / 7 tests passed。13 个 endpoint 统一保持 `available-in-apps-api-not-caller-verified`，只代表本地 apps/api 可达与 JsonVO contract，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback 或旧服务可退役。
- [x] 2026-05-19 补齐 `patrol-manage` 6 个与 `parking-manage` 4 个 admin list endpoint 的 runtime manifest/contract/HTTP gate 护栏：`runtime-endpoints.ts` 新增 10 个 admin canonical manifest 条目，`tests/infra/endpoint-manifest.test.ts`、`tests/infra/phase7-api-contracts.test.ts` 和 `tests/http/phase7-gated-http.test.ts` 均显式覆盖。fresh `apps/api` 3115 gated HTTP 1 file / 8 tests passed。10 个 endpoint 统一保持 `available-in-apps-api-not-caller-verified`，只代表本地 apps/api 可达与 JsonVO contract，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback、真实页面 CRUD/交互或旧服务可退役。
- [x] 2026-05-19 补齐 `property-manage/expense-manage` 14 个 admin list endpoint 的 runtime manifest/contract/HTTP gate 护栏：`runtime-endpoints.ts` 新增 14 个 admin canonical manifest 条目，`tests/infra/endpoint-manifest.test.ts`、`tests/infra/phase7-api-contracts.test.ts` 和 `tests/http/phase7-gated-http.test.ts` 均显式覆盖。fresh `apps/api` 3116 gated HTTP 1 file / 9 tests passed。14 个 endpoint 统一保持 `available-in-apps-api-not-caller-verified`，只代表本地 apps/api 可达与 JsonVO contract，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback、真实页面 CRUD/交互或旧服务可退役。
- [x] 2026-05-19 补齐 `property-manage/report-manage` 12 个只读 admin canonical list endpoint 的 runtime manifest/contract/HTTP gate 护栏：`runtime-endpoints.ts` 新增 12 个 admin canonical manifest 条目，统一为 `ownerModule=fee-report`、`responseContract=JsonVO`、`available-in-apps-api-not-caller-verified`；`tests/infra/endpoint-manifest.test.ts`、`tests/infra/phase7-api-contracts.test.ts` 和 `tests/http/phase7-gated-http.test.ts` 均显式覆盖。fresh `apps/api` 3117 gated HTTP 1 file / 10 tests passed。该进度只代表本地 apps/api runtime manifest/contract/HTTP gate 补齐，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback、真实页面 CRUD/交互或旧服务可退役。
- [x] 2026-05-19 补齐 `property-manage/community-manage` 7 个 admin list endpoint 的 runtime manifest/contract/HTTP gate 护栏：`runtime-endpoints.ts` 新增 7 个 admin canonical manifest 条目，统一为 `ownerModule=community`、`responseContract=JsonVO`、`available-in-apps-api-not-caller-verified`；`tests/infra/endpoint-manifest.test.ts`、`tests/infra/phase7-api-contracts.test.ts` 和 `tests/http/phase7-gated-http.test.ts` 均显式覆盖。fresh `apps/api` 3118 gated HTTP 1 file / 11 tests passed，复核子代理确认无 endpoint 缺漏、无业务 handler/旧服务目录改动。该进度只代表本地 apps/api runtime manifest/contract/HTTP gate 补齐，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback、真实页面 CRUD/交互或旧服务可退役。
- [x] 2026-05-19 补齐 `property-manage/house-property-manage` 10 个 admin list endpoint 的 runtime manifest/contract/HTTP gate 护栏：`runtime-endpoints.ts` 新增 10 个 admin canonical manifest 条目，统一为 `ownerModule=house-property`、`responseContract=JsonVO`、`available-in-apps-api-not-caller-verified`；`tests/infra/endpoint-manifest.test.ts`、`tests/infra/phase7-api-contracts.test.ts` 和 `tests/http/phase7-gated-http.test.ts` 均显式覆盖，并补齐 `phase7-house-property-manage-admin-list` 断言。fresh `apps/api` 3119 gated HTTP 1 file / 12 tests passed，复核子代理确认 `phase` 断言完整且未破坏其他批次语义。该进度只代表本地 apps/api runtime manifest/contract/HTTP gate 补齐，不代表生产 `DB_READY`、真实库样本、shadow-off/fallback、真实页面 CRUD/交互或旧服务可退役。
- [x] 2026-05-19 中断前接力保全：已关闭 `contract-manage` 编辑子代理且确认未落盘 contract 变更；主控扫描确认 `contract-manage` 12 个普通 list endpoint 仍缺 runtime manifest/contract/HTTP gate。下一轮只补这 12 个 list；upload/R2、写入、删除、detail 继续保持排除并单独评审。
- [x] 2026-05-18 `report-manage/expense-summary-table` 路径冲突已由独立 route/hook 闭环解决；后续不再把该项列为待决策。
...
- [ ] 仍缺 Chrome MCP / 页面 Network 证据；当前只能标 `db-read-repository-wired`，不得写 `DB_READY`。
- [ ] 本批未涉及写入口，未触发 guard/read-back/rollback。
- [x] 2026-05-18 Admin 旧路径全覆盖批次完成：48 个未覆盖旧路径和 `report-manage/expense-summary-table/list.post.ts` 均已在 `apps/api` 补齐 route 实现。`apps/api/server/routes/api/**/*.ts` 从 109 增长到 160 个；admin old path exact coverage 为 155/155。
  - dev-team/config-manage（16）：center/type/item/dictionary 各 4 个 create/detail.get/update/delete route + repository/service/adapter CRUD 扩展（DB 实现 + InMemory fallback）
  - setting-manage/system-manage（15）：change-password/community-configuration/initialize-cell/register-protocol/system-config 各 3 个 create/update/delete route + adapter CUD 扩展（InMemory fallback）
  - property-manage/contract-manage（13）：change CRUD(4) + draft-contract CRUD(4) + upload 分片上传(5: init/sign-part/complete/abort/status) + adapter 扩展（InMemory fallback，upload 暂未对接 R2）
  - 边缘接口（3）：setting-manage/organize-manage/org-info/tree.post.ts、j1-dashboard/center/commonmenu/get.ts、debug-env.get.ts
...
当前 working tree 口径：`apps/api/server/routes/api/**/*.ts` 为 160 个 server route；`apps/admin/server/api/**/*.ts` 为 155 个 legacy file；admin old path exact coverage 为 155/155。生产 readiness 仍只能写 `READY_CONFIGURED-only`，直到 `RUN_PHASE7_DB_READINESS_CHECK=1` 且 `/__nitro/ready` 返回 `DB_READY`。
...
- 下一轮建议继续处理 Neon main `DB_READY`、真实库样本复核、shadow-off/fallback 页面演练；**admin 前端 resolver 迁移已全部完成**，后续不再有 resolver 缺口。2026-05-16 最终批次已补齐 `community-manage`(7)、`house-property-manage`(9)、`contract-manage`(11)、`repairs-manage`(4)、`dev-team/menu-manage`(3)、`dev-team/cache-manage`(1)、`setting-manage/organize-manage`(2) 共 37 个 hook resolver + 5 个新测试文件 / 108 tests passed。

### 17.1.3 2026-05-18 接力状态

- 本轮先完成三份 Phase7 进度文档初始同步；随后代码编辑子代理完成 `property-manage/report-manage/expense-summary-table/list` route/hook 闭环，本节据此二次同步文档。
- 最新事实源按主控验证与当前扫描为准：admin 旧路径 exact coverage 为 155/155；`apps/api/server/routes/api/**/*.ts` 为 160 个 server route；`property-manage/report-manage/expense-summary-table/list` 已独立实现并接 resolver。admin 前端 resolver 已全完成，`community-manage`、`dev-team/menu-manage`、`cache-manage` 不再是 resolver 缺口。
- 主控验证通过：API Vitest 1 file / 4 tests，admin hook Vitest 1 file / 3 tests，api typecheck，admin typecheck，`git diff --check`。
- final batch 页面/API shadow 证据：`.tmp/phase7-dev-browser/2026-05-16-final-batch-page-network-verification.log`，44/44 PASS；shadow-off/fallback 本地演练：`.tmp/phase7-dev-browser/2026-05-16-final-batch-shadow-verification.log`。这些证据只支持本地 shadow / fallback 口径，不能升级为生产 `DB_READY`、真实旧服务可退役或 App legacy 页面退役证据。
- App legacy 21 endpoint 证据仍保持 Nitro manifest / allowlist / guard / fallback 口径；其中 `/app/ownerRepair.listOwnerRepairs`、`/app/dict.queryRepairStates`、`/app/ownerRepair.queryOwnerRepair` 已在 2026-05-18 补本地 App H5 页面上下文 Network 证据，但仍不能写成生产 `DB_READY`、shadow-off/fallback、写入口闭环或退役证据。
- 2026-05-18 验证接力更新：Windows admin dev 阻塞已处理，`apps/admin/package.json` 的 `vite:dev` 已改用 `cross-env`，并通过 `VITE_DISABLE_AUTOGENERATION_IMPORT_FILE=true` 禁用会在 Windows `fs.watch` null fileName 场景下崩溃的 `vite-plugin-autogeneration-import-file`。本地 fresh `apps/api` 3103 与 `apps/admin` 8080 已完成 `/api-shadow` 闭环；Chrome MCP 打开 `http://127.0.0.1:8080/#/property-manage/report-manage/expense-summary-table`，真实页面发出 `POST /api-shadow/api/property-manage/report-manage/expense-summary-table/list` 返回 200、`x-api-phase=phase3-infra`、`success=true`、`total=2`，表格显示 `物业费`、`停车费`、应收/实收/收缴率字段。随后继续补齐 P1 `report-manage` 剩余 7 页页面级 Network：`arrears-details-list`、`data-statistics`、`deposit-report`、`fee-reminder`、`no-charge-house`、`outstanding-fees-analysis`、`patrol-report` 均由真实页面发出 `/api-shadow/api/property-manage/report-manage/**/list`，返回 200、`x-api-phase=phase3-infra`、`success=true`；证据文件 `.tmp/phase7-dev-browser/2026-05-18-report-manage-remaining-page-network-verification.md`。随后启动 `apps/app` H5 3000 shadow 环境（`VITE_11COMM_API_SHADOW_ENABLE=true`、`VITE_11COMM_API_BASE_URL=http://127.0.0.1:3102`），补齐 App repair 只读三端点页面上下文 Network：`/app/ownerRepair.listOwnerRepairs`、`/app/dict.queryRepairStates`、`/app/ownerRepair.queryOwnerRepair` 均命中 `apps/api` 3102，返回 200、`x-api-phase=phase3-infra`、旧格式 `code=0`；证据文件 `.tmp/phase7-dev-browser/2026-05-18-app-repair-readonly-h5-network-verification.md`。本轮 App repair 证据因 Chrome DevTools MCP transport 断开，采用 Google Chrome CDP fallback 采集；后续如需 MCP 工具级证据需重采。
- 下一步：`report-manage/expense-summary-table/list`、P1 `report-manage` 剩余 7 页、以及 App repair 只读三端点 `/app/ownerRepair.listOwnerRepairs`、`/app/dict.queryRepairStates`、`/app/ownerRepair.queryOwnerRepair` 不再列为本地页面 Network 待补；后续继续补 `/app/repairSetting.listRepairSettings` 页面证据、其他未覆盖页面/端点、CRUD DB/R2、生产 `DB_READY`、App 端后续批次、真实库样本复核、shadow-off/fallback、必要写入回滚和独立复核证据。退役评估仍保持 no-go。

### 17.2 下一个 AI 如何接力

1. **admin 旧路径精确覆盖已达 155/155**（2026-05-18）。`apps/api/server/routes/api/**/*.ts` 从 109 增长到 160 个；`report-manage/expense-summary-table/list.post.ts` 已独立实现。
2. **admin 前端 resolver 迁移已全部完成**（2026-05-18）。`apps/admin/src/api/**/index.ts` 中不再保留 `report-manage/expense-summary-table` 路径冲突硬编码项。
3. 本轮补齐 48 个 CRUD/边缘 route：
   - dev-team/config-manage（16）：center/type/item/dictionary 各 4 个 create/detail.get/update/delete + repository/service/adapter CRUD 扩展
   - setting-manage/system-manage（15）：5 个模块各 3 个 create/update/delete + adapter CUD 扩展
   - property-manage/contract-manage（13）：change CRUD(4) + draft-contract CRUD(4) + upload(5) + adapter 扩展
   - 边缘接口（3）：org-info/tree、j1-dashboard/commonmenu、debug-env
   - 所有新增 CRUD 方法当前为 InMemory fallback，不涉及真实 DB 写入
4. `report-manage/expense-summary-table/index.ts` 已接入 resolver；`apps/api` 已有独立 `property-manage/report-manage/expense-summary-table/list.post.ts`，语义上读取 `rptExpenseSummaries`，不复用 expense-manage 路径。
5. 下一步工作重点（按优先级）：
   - Chrome MCP 页面 Network / HTTP gate 补证：`property-manage/report-manage/expense-summary-table/list`、P1 `report-manage` 剩余 7 页、App repair 只读三端点 `/app/ownerRepair.listOwnerRepairs`、`/app/dict.queryRepairStates`、`/app/ownerRepair.queryOwnerRepair` 已补本地页面级证据；`repairs-manage` 7 个 admin list old path 已补 runtime manifest/contract 与 fetch 型 HTTP gate 证据。其余新增 route 对应的 admin/app 页面或无页面入口端点仍需逐项补证。
   - CRUD 接口的真实 DB 实现：当前所有 CUD 方法为 InMemory fallback，需要后续接入 Drizzle DB 操作。
   - upload 接口的 R2 对接评审：contract-manage/upload 5 个接口需要独立的 R2/分片上传方案。
   - App 端批次 1-5 推进，优先补 `/app/repairSetting.listRepairSettings` 只读页面证据，并继续保持 `/app/ownerRepair.saveOwnerRepair` 等写入口 guard。
   - 最后才进入旧服务退役候选评估。
6. 验证命令参考：`pnpm -F @01s-11comm/api run typecheck` 通过。
7. 评估前不得删除、移动、归档、重命名或清空 `apps/admin/server`、`apps/app/server`、`D:\code\ruan-cat\01s-11comm-app`。
