...
const hasVerifiedIdentity = Boolean(
	currentUser.phone_confirmed_at || currentUser.email_confirmed_at || currentUser.user_metadata?.username,
);
...
console.log(userResult.data.user.email, userResult.data.user.phone, userResult.data.user.user_metadata?.nickName);
