...
export async function petUsingPut({ body, options }: { body: API.Pet; options?: CustomRequestOptions }) {
...
export async function petUsingPost({ body, options }: { body: API.Pet; options?: CustomRequestOptions }) {
	return request<unknown>("/pet", {
		method: "POST",
		headers: {
			"Content-Type": "application/json",
