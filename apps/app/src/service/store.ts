...
export async function storeInventoryUsingGet({ options }: { options?: CustomRequestOptions }) {
...
export async function storeOrderUsingPost({ body, options }: { body: API.Order; options?: CustomRequestOptions }) {
