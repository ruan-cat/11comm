...
export async function userUsingPost({ body, options }: { body: API.User; options?: CustomRequestOptions }) {
...
export async function userLogoutUsingGet({ options }: { options?: CustomRequestOptions }) {
