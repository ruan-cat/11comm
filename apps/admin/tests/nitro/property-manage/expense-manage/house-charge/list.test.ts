/**
 * @file 房屋收费列表接口测试
 * @description 测试 /api/property-manage/expense-manage/house-charge/list 接口
 */
...
describe("房屋收费列表接口测试", () => {
	...
	test("POST /api/property-manage/expense-manage/house-charge/list - 获取房屋收费列表", async () => {
		// 调用接口
