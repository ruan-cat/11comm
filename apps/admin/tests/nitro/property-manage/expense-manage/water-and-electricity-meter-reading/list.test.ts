/**
 * @file 水电抄表列表接口测试
 * @description 测试 /api/property-manage/expense-manage/water-and-electricity-meter-reading/list 接口
 */
...
describe("水电抄表列表接口测试", () => {
	...
	test("POST /api/property-manage/expense-manage/water-and-electricity-meter-reading/list - 获取水电抄表列表", async () => {
		// 调用接口
