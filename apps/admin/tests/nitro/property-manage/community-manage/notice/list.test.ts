/**
 * @file 通知公告列表接口测试
 * @description 测试 /api/property-manage/community-manage/notice/list 接口
 */
...
describe("通知公告列表接口测试", () => {
	...
	test("POST /api/property-manage/community-manage/notice/list - 获取通知公告列表", async () => {
		// 调用接口
