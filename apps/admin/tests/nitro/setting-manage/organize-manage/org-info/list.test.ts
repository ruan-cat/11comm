/**
 * @file 组织信息列表接口测试
 * @description 测试 /api/setting-manage/organize-manage/org-info/list 接口
 */
...
describe("组织信息列表接口测试", () => {
	...
	test("POST /api/setting-manage/organize-manage/org-info/list - 获取组织信息列表", async () => {
		// 调用接口
