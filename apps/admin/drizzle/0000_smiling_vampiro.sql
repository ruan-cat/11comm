...
CREATE UNIQUE INDEX "ct_contracts_contract_number_idx" ON "ct_contracts" USING btree ("contract_number");--> statement-breakpoint
...
CREATE UNIQUE INDEX "pk_owner_vehicles_license_plate_idx" ON "pk_owner_vehicles" USING btree ("license_plate");--> statement-breakpoint
...
CREATE UNIQUE INDEX "rp_repair_orders_work_order_number_idx" ON "rp_repair_orders" USING btree ("work_order_number");--> statement-breakpoint
CREATE INDEX "rp_repair_orders_status_idx" ON "rp_repair_orders" USING btree ("status");--> statement-breakpoint
CREATE INDEX "rp_repair_orders_created_at_idx" ON "rp_repair_orders" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "dt_menu_items_path_idx" ON "dt_menu_items" USING btree ("path");