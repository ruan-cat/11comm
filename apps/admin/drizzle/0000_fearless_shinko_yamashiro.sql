...
CREATE TABLE "ct_attachments" (
	...
	"upload_status" varchar(20) DEFAULT 'ready' NOT NULL,
	"remark" text,
	"create_time" timestamp DEFAULT now() NOT NULL,
	"update_time" timestamp DEFAULT now() NOT NULL
);
...
--> statement-breakpoint
CREATE TABLE "ct_upload_session_parts" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "ct_upload_sessions" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
ALTER TABLE "ct_attachments" ADD CONSTRAINT "ct_attachments_change_id_ct_changes_id_fk" FOREIGN KEY ("change_id") REFERENCES "public"."ct_changes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ct_attachments" ADD CONSTRAINT "ct_attachments_upload_session_id_ct_upload_sessions_id_fk" FOREIGN KEY ("upload_session_id") REFERENCES "public"."ct_upload_sessions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ct_upload_session_parts" ADD CONSTRAINT "ct_upload_session_parts_session_id_ct_upload_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."ct_upload_sessions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "ct_attachments_change_id_idx" ON "ct_attachments" USING btree ("change_id");--> statement-breakpoint
CREATE INDEX "ct_attachments_upload_session_id_idx" ON "ct_attachments" USING btree ("upload_session_id");--> statement-breakpoint
...
CREATE INDEX "ct_upload_session_parts_session_id_idx" ON "ct_upload_session_parts" USING btree ("session_id");--> statement-breakpoint
CREATE UNIQUE INDEX "ct_upload_session_parts_session_part_idx" ON "ct_upload_session_parts" USING btree ("session_id","part_number");--> statement-breakpoint
CREATE INDEX "ct_upload_sessions_biz_type_idx" ON "ct_upload_sessions" USING btree ("biz_type");--> statement-breakpoint
CREATE INDEX "ct_upload_sessions_status_idx" ON "ct_upload_sessions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "ct_upload_sessions_resume_fingerprint_idx" ON "ct_upload_sessions" USING btree ("resume_fingerprint");--> statement-breakpoint
