...
/** API 路径 */
const API_URL = resolveAdminApiRequestUrl("/api/property-manage/expense-manage/cancel-fee/list", import.meta.env);
 ...
 */
export function useCancelFeeListQuery(initialParams: Partial<CancelFeeQueryParams>) {
