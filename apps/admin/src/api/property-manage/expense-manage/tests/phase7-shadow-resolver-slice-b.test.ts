...
const EXPENSE_MANAGE_SLICE_B_MODULES = [
	{
...
describe("phase7 property-manage expense-manage slice b admin api shadow resolver", () => {
	beforeEach(() => {
		vi.clearAllMocks();
		vi.unstubAllEnvs();
	});
	...
	test.each(EXPENSE_MANAGE_SLICE_B_MODULES)(
