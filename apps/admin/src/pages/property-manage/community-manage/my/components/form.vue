...
import { ExpenseItemSettingFormProps, 小区信息类型, 小区信息项修改表单_VO, defaultForm } from "./form";

const props = defineProps<ExpenseItemSettingFormProps>();

/** 默认的表单重置变量 */
const defaultValues = props.defaultValues as FieldValues & 小区信息项修改表单_VO;
 ...
 */
const toRefForm = cloneDeep(props.form) as FieldValues & 小区信息项修改表单_VO;
