...
export const tableData: 业务受理_列表数据[] = Array(35)
	...
	.map((_, index) => {
		const companyNames = [
			"华为技术有限公司", "腾讯科技(深圳)有限公司", "阿里巴巴(中国)有限公司", "百度(中国)有限公司",
			"京东集团股份有限公司", "网易(杭州)网络有限公司", "美团点评", "字节跳动科技有限公司",
			"小米科技有限责任公司", "OPPO广东移动通信有限公司", "vivo移动通信有限公司", "联想(北京)有限公司",
		];
		const contractorNames = [
			"中建三局集团有限公司", "中铁建设集团有限公司", "中交第一航务工程局有限公司", "中国建筑第八工程局有限公司",
			"上海建工集团股份有限公司", "北京建工集团有限责任公司", "中国水利水电建设集团", "中国铁建股份有限公司",
		];
		const changeReasons = [
		...
		const contractNames = [
			"智能办公设备采购合同", "企业信息化系统开发合同", "物业管理服务合同", "办公场所租赁合同",
			"数据中心建设项目合同", "云服务平台建设合同", "网络安全服务合同", "设备维护保养合同",
		];
