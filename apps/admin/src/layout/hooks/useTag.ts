...
export function useTags() {
	...
	const tagsViews = reactive<Array<tagsViewsType>>([
		{
			icon: RefreshRight,
			text: $t("common.buttons.pureReload"),
			divided: false,
			disabled: false,
			show: true,
		},
		{
			icon: Close,
			text: $t("common.buttons.pureCloseCurrentTab"),
			divided: false,
		...
		{
			icon: CloseLeftTags,
			text: $t("common.buttons.pureCloseLeftTabs"),
			divided: true,
			disabled: multiTags.value.length > 1 ? false : true,
			show: true,
		},
		{
			icon: CloseRightTags,
			text: $t("common.buttons.pureCloseRightTabs"),
			divided: false,
			disabled: multiTags.value.length > 1 ? false : true,
			show: true,
		},
		{
			icon: CloseOtherTags,
			text: $t("common.buttons.pureCloseOtherTabs"),
			divided: true,
		...
		{
			icon: CloseAllTags,
			text: $t("common.buttons.pureCloseAllTabs"),
			divided: false,
			disabled: multiTags.value.length > 1 ? false : true,
			show: true,
		},
		{
			icon: Fullscreen,
			text: $t("common.buttons.pureContentFullScreen"),
			divided: true,
			disabled: false,
			show: true,
		},
