			...
			<el-dropdown trigger="click">
				...
				<template #dropdown>
					<el-dropdown-item @click="toAccountSettings">
						...
						{{ t("common.buttons.pureAccountSettings") }}
					</el-dropdown-item>
					<el-dropdown-menu class="logout">
						<el-dropdown-item @click="logout">
							<IconifyIconOffline :icon="LogoutCircleRLine" style="margin: 5px" />
							{{ t("common.buttons.pureLoginOut") }}
						</el-dropdown-item>
					</el-dropdown-menu>
				</template>
			</el-dropdown>
			<span class="set-icon navbar-bg-hover" :title="t('common.buttons.pureOpenSystemSet')" @click="onPanel">
