...
export const noticesData: TabItem[] = [
	{
		key: "1",
		name: $t("common.status.pureNotify"),
		list: [],
		emptyText: $t("common.status.pureNoNotify"),
	},
	{
		key: "2",
		name: $t("common.status.pureMessage"),
		list: [
			{
		...
		emptyText: $t("common.status.pureNoMessage"),
	},
	{
		key: "3",
		name: $t("common.status.pureTodo"),
		list: [
			{
				avatar: "",
				title: "第三方紧急代码变更",
		...
		emptyText: $t("common.status.pureNoTodo"),
	},
];
