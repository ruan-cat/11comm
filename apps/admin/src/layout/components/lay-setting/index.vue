...
const stretchTypeOptions = computed<Array<OptionsType>>(() => {
	return [
		{
			label: t("common.panel.pureStretchFixed"),
			tip: t("common.panel.pureStretchFixedTip"),
			value: "fixed",
		},
		{
			label: t("common.panel.pureStretchCustom"),
			tip: t("common.panel.pureStretchCustomTip"),
			value: "custom",
		},
	];
});
...
const themeOptions = computed<Array<OptionsType>>(() => {
	return [
		{
			label: t("common.panel.pureOverallStyleLight"),
			icon: DayIcon,
			theme: "light",
			tip: t("common.panel.pureOverallStyleLightTip"),
			iconAttrs: { fill: isDark.value ? "#fff" : "#000" },
		},
		{
			label: t("common.panel.pureOverallStyleDark"),
			icon: DarkIcon,
			theme: "dark",
			tip: t("common.panel.pureOverallStyleDarkTip"),
			iconAttrs: { fill: isDark.value ? "#fff" : "#000" },
		},
		{
			label: t("common.panel.pureOverallStyleSystem"),
			icon: SystemIcon,
			theme: "system",
			tip: t("common.panel.pureOverallStyleSystemTip"),
			iconAttrs: { fill: isDark.value ? "#fff" : "#000" },
		},
	];
});
...
const markOptions = computed<Array<OptionsType>>(() => {
	return [
		{
			label: t("common.panel.pureTagsStyleSmart"),
			tip: t("common.panel.pureTagsStyleSmartTip"),
			value: "smart",
		},
		{
			label: t("common.panel.pureTagsStyleCard"),
			tip: t("common.panel.pureTagsStyleCardTip"),
			value: "card",
		},
		{
			label: t("common.panel.pureTagsStyleChrome"),
			tip: t("common.panel.pureTagsStyleChromeTip"),
			value: "chrome",
		},
	];
});
...
<template>
	<LayPanel>
		<div class="p-5">
			<p :class="pClass">{{ t("common.panel.pureOverallStyle") }}</p>
			<Segmented
				resize
				class="select-none"
			...
			<p :class="['mt-5!', pClass]">{{ t("common.panel.pureThemeColor") }}</p>
			...
			<p :class="['mt-5!', pClass]">{{ t("common.panel.pureLayoutModel") }}</p>
			<ul class="pure-theme">
				<li
					ref="verticalRef"
					v-tippy="{
						content: t('common.panel.pureVerticalTip'),
						zIndex: 41000,
					}"
				...
				<li
					...
					ref="horizontalRef"
					v-tippy="{
						content: t('common.panel.pureHorizontalTip'),
						zIndex: 41000,
					}"
				...
				<li
					...
					ref="mixRef"
					v-tippy="{
						content: t('common.panel.pureMixTip'),
						zIndex: 41000,
					}"
			...
			<span v-if="useAppStoreHook().getViewportWidth > 1280">
				<p :class="['mt-5!', pClass]">{{ t("common.panel.pureStretch") }}</p>
				<Segmented
					resize
			...
			<p :class="['mt-4!', pClass]">{{ t("common.panel.pureTagsStyle") }}</p>
			<Segmented
				resize
				class="select-none"
			...
			<p class="mt-5! font-medium text-sm dark:text-white">
				{{ t("common.panel.pureInterfaceDisplay") }}
			</p>
			<ul class="setting">
				<li>
					<span class="dark:text-white">{{ t("common.panel.pureGreyModel") }}</span>
					<el-switch
						v-model="settings.greyVal"
						inline-prompt
						:active-text="t('common.buttons.pureOpenText')"
						:inactive-text="t('common.buttons.pureCloseText')"
						@change="greyChange"
					/>
				</li>
				<li>
					<span class="dark:text-white">{{ t("common.panel.pureWeakModel") }}</span>
					<el-switch
				...
				<li>
					<span class="dark:text-white">{{ t("common.panel.pureHiddenTags") }}</span>
					<el-switch
				...
				<li>
					<span class="dark:text-white">{{ t("common.panel.pureHiddenFooter") }}</span>
					<el-switch
				...
				<li>
					<span class="dark:text-white">
						{{ t("common.panel.pureMultiTagsCache") }}
					</span>
					<el-switch
