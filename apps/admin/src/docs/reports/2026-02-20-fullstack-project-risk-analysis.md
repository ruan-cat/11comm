...
| 序号 | 风险点         | 等级  | 影响             |
| ---- | -------------- | ----- | ---------------- |
| 1    | as any 滥用    | 🔴 高 | 类型安全失效     |
| 2    | mock 死代码    | 🟡 中 | 105 个文件无意义 |
| 3    | try-catch 重复 | 🟡 中 | 140+处代码重复   |
| 4    | FIXME 全局导入 | 🟡 中 | 无法全局类型导入 |
...
├─────────────────────────────────────────────────────────────┤
│ 1. 为 apps:type 添加 Schema 验证测试                       │
│ 2. 完善 Turbo 任务定义 (至少补充 lint/test/typecheck)      │
└─────────────────────────────────────────────────────────────┘
