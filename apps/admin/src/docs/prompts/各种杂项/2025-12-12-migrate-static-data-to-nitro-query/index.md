...
| 文档 | 用途 | 阅读时间 |
|:---|:---|:---:|
| [000-CORE-RULES.md](./000-CORE-RULES.md) 🔴 | **核心规范一页纸** - 最重要的5个必须做和3个禁止做 | 3分钟 |
| [001-CHECKLIST.md](./001-CHECKLIST.md) 🔴 | **可执行检查清单** - 迁移单个页面的完整步骤 | 5分钟 |
| 本文档 (index.md) | 完整迁移指南 - 详细的10步骤流程 | 30分钟 |
...
5. 请你主动的开启多个独立并行的修改子代理，加快修改任务。
6. 有绝大多数的文件，都不同程度按照要求来做，但是这些代码做的都缺斤少两，缺少很多代码写法。在你批量的，按照要求修改代码时，务必要**仔细**的阅读每一份文件，仔细的阅读对照规范文档的修改要求。你应该新建一个专门的子代理，将现有的代码做非常严格的检查。按照以下步骤作为检查清单，结合规范文档，逐个检查，排查，补全代码写法：
