...
/**
 * @description owner-information列表 POST API
 * OwnerInformation list POST API
 */
export default defineEventHandler(async (event): Promise<JsonVO<PageDTO<OwnerInformationListItem>>> => {
