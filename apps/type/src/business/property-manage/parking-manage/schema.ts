...
// --- pkParkingLots ---
export const insertPkParkingLotSchema = createInsertSchema(pkParkingLots, {
...
export const updatePkParkingLotSchema = z.object({
	id: z.string().uuid(),
	communityId: z.string().uuid().optional().nullable(),
	lotName: z.string().min(1, "停车场名称不能为空").max(100).optional(),
	lotType: z.string().max(50).optional().nullable(),
	totalSpaces: z.number().int().optional().nullable(),
	availableSpaces: z.number().int().optional().nullable(),
...
// --- pkCarports ---
export const insertPkCarportSchema = createInsertSchema(pkCarports, {
...
export const updatePkCarportSchema = z.object({
	id: z.string().uuid(),
	parkingLotId: z.string().uuid().optional().nullable(),
	carportNumber: z.string().min(1, "车位编号不能为空").max(50).optional(),
	carportType: z.string().max(50).optional().nullable(),
	area: z.string().optional().nullable(),
	status: z.string().max(20).optional().nullable(),
	ownerId: z.string().uuid().optional().nullable(),
	ownerName: z.string().max(50).optional().nullable(),
	contactPhone: z.string().max(20).optional().nullable(),
	boundVehicle: z.string().max(20).optional().nullable(),
...
// --- pkOwnerVehicles ---
export const insertPkOwnerVehicleSchema = createInsertSchema(pkOwnerVehicles, {
...
export const selectPkOwnerVehicleSchema = createSelectSchema(pkOwnerVehicles);

export const updatePkOwnerVehicleSchema = z.object({
	id: z.string().uuid(),
	ownerId: z.string().uuid().optional().nullable(),
	carportId: z.string().uuid().optional().nullable(),
	licensePlate: z.string().min(1, "车牌号不能为空").max(20).optional(),
	plateType: z.string().max(20).optional().nullable(),
	vehicleType: z.string().max(50).optional().nullable(),
	vehicleColor: z.string().max(20).optional().nullable(),
	brand: z.string().max(50).optional().nullable(),
	relatedHouse: z.string().max(100).optional().nullable(),
	validityStart: z.string().optional().nullable(),
	validityEnd: z.string().optional().nullable(),
});

// --- pkCarportApplications ---
export const insertPkCarportApplicationSchema = createInsertSchema(pkCarportApplications, {
...
export const updatePkCarportApplicationSchema = z.object({
	id: z.string().uuid(),
	applicant: z.string().min(1, "申请人不能为空").max(50).optional(),
	carportType: z.string().max(50).optional().nullable(),
	applyTime: z.date().optional(),
	expectedPriceRange: z.string().max(100).optional().nullable(),
	status: z.string().max(20).optional(),
	approver: z.string().max(50).optional().nullable(),
	approvalTime: z.date().optional().nullable(),
	approvalOpinion: z.string().optional().nullable(),
	allocatedCarport: z.string().max(50).optional().nullable(),
});

// --- pkParkingStructures ---
export const insertPkParkingStructureSchema = createInsertSchema(pkParkingStructures, {
...
export const updatePkParkingStructureSchema = z.object({
	id: z.string().uuid(),
	parkingLotId: z.string().uuid().optional(),
	regionName: z.string().min(1, "区域名称不能为空").max(50).optional(),
	structureData: z.string().optional().nullable(),
...
export type UpdatePkParkingLot = z.infer<typeof updatePkParkingLotSchema>;

export type PkCarport = typeof pkCarports.$inferSelect;
export type NewPkCarport = typeof pkCarports.$inferInsert;
export type UpdatePkCarport = z.infer<typeof updatePkCarportSchema>;
...
export type UpdatePkOwnerVehicle = z.infer<typeof updatePkOwnerVehicleSchema>;
...
export type UpdatePkCarportApplication = z.infer<typeof updatePkCarportApplicationSchema>;
...
export type UpdatePkParkingStructure = z.infer<typeof updatePkParkingStructureSchema>;
