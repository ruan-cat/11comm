...
describe("endpoint registry runtime", () => {
	...
	test("runtime endpoint definitions include only allowed Phase2, Phase4A, and Phase7 legacy endpoints", () => {
		...
		expect(findEndpointDefinition(registry, "GET", "/app/staff/update-online-status")).toBeUndefined();
		expect(findEndpointDefinition(registry, "POST", "/app/staff/update-online-status")).toBeTruthy();
		expect(findEndpointDefinition(registry, "GET", "/app/staff/add")).toBeUndefined();
		expect(findEndpointDefinition(registry, "POST", "/app/staff/add")).toBeTruthy();
		...
		expect(findEndpointDefinition(registry, "GET", "/app/purchaseApply.listPurchaseApplys")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/purchaseApply.listPurchaseApplys")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/itemRelease.listItemRelease")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/itemRelease.listItemRelease")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/purchaseApply.listMyAuditOrders")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/purchaseApply.listMyAuditOrders")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/itemRelease.queryUndoItemRelease")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/itemRelease.queryUndoItemRelease")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/resourceStore.listAllocationStoreAuditOrders")).toBeTruthy();
		expect(
			findEndpointDefinition(registry, "POST", "/app/resourceStore.listAllocationStoreAuditOrders"),
		).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/resourceStore.listAllocationStorehouses")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/resourceStore.listAllocationStorehouses")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/resourceStore.queryMyResourceStoreInfo")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/resourceStore.queryMyResourceStoreInfo")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/resourceStore.saveAllocationStorehouse")).toBeUndefined();
		expect(findEndpointDefinition(registry, "POST", "/app/resourceStore.saveAllocationStorehouse")).toBeTruthy();
		expect(findEndpointDefinition(registry, "GET", "/app/purchaseApply.auditApplyOrder")).toBeUndefined();
		expect(findEndpointDefinition(registry, "POST", "/app/purchaseApply.auditApplyOrder")).toBeTruthy();
		expect(findEndpointDefinition(registry, "GET", "/app/itemRelease.auditUndoItemRelease")).toBeUndefined();
		expect(findEndpointDefinition(registry, "POST", "/app/itemRelease.auditUndoItemRelease")).toBeTruthy();
		expect(findEndpointDefinition(registry, "GET", "/app/resourceStore.auditAllocationStoreOrder")).toBeUndefined();
		expect(findEndpointDefinition(registry, "POST", "/app/resourceStore.auditAllocationStoreOrder")).toBeTruthy();
		...
		expect(findEndpointDefinition(registry, "GET", "/app/parkingArea.listParkingAreas")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/parkingArea.listParkingAreas")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/machine.listParkingAreaMachines")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/machine.listParkingAreaMachines")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/carInout.listCarInParkingAreaCmd")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/carInout.listCarInParkingAreaCmd")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/parkingCoupon.listParkingCouponCar")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/parkingCoupon.listParkingCouponCar")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/tempCarFee.getTempCarFeeOrder")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/tempCarFee.getTempCarFeeOrder")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/carInoutDetail.listCarInoutDetail")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/carInoutDetail.listCarInoutDetail")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/carInoutPayment.listCarInoutPayment")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/carInoutPayment.listCarInoutPayment")).toBeUndefined();
		expect(findEndpointDefinition(registry, "GET", "/app/machine.getBarrierCloudVideo")).toBeTruthy();
		expect(findEndpointDefinition(registry, "POST", "/app/machine.getBarrierCloudVideo")).toBeUndefined();
		expect(findEndpointDefinition(registry, "POST", "/app/machine/closeDoor")).toBeTruthy();
		expect(findEndpointDefinition(registry, "GET", "/app/machine/closeDoor")).toBeUndefined();
		expect(findEndpointDefinition(registry, "POST", "/app/machine.customCarInOutCmd")).toBeTruthy();
		expect(findEndpointDefinition(registry, "GET", "/app/machine.customCarInOutCmd")).toBeUndefined();
