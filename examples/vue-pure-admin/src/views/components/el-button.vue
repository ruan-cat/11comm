...
<template>
	<el-card shadow="never">
		...
		<el-button tag="div" role="button" tabindex="0" :size="dynamicSize" :disabled="size === 'disabled'">
			div 标签
		</el-button>
		<el-button
			type="primary"
		...
		<el-space wrap>
			...
			<el-button color="#626aef" :size="dynamicSize" :disabled="size === 'disabled'" :dark="isDark" plain>
				Plain
			</el-button>
		</el-space>
	</el-card>
