...
import { request, requestNoAuth } from "../../lib/java110/request.js";
/**
 * 查询下一处理人
...
export function getVisit(_that, dataObj) {
	dataObj.iotApiCode = "listVisitBmoImpl";
 ...
 * @param {Object} _data
 */
export function auditVisit(_that, _data) {
	_data.iotApiCode = "propertyAuthVisitBmoImpl";
	return new Promise(function (reslove, reject) {
		_that.context.post({
