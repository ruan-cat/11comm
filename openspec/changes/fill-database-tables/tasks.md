...
- [x] **2.1.1 读取 dt_dictionaries 表结构**
...
- [x] **2.1.3 创建 dt_dictionaries 的 mock 数据文件**
...
- [x] **2.1.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的字典数据（来自 2.1.4）
  - **输出**：格式验证报告
...
- [x] **2.2.1 读取 dt_dictionary_items 表结构**
...
- [x] **2.2.3 创建 dt_dictionary_items 的 mock 数据文件**
...
- [x] **2.2.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **2.3.1 读取 dt_cache_configs 表结构**
...
- [x] **2.3.3 创建 dt_cache_configs 的 mock 数据文件**
  - **输入**：表结构（来自 2.3.1）
...
- [x] **2.3.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **2.4.1 读取 dt_config_types 表结构**
...
- [x] **2.4.3 创建 dt_config_types 的 mock 数据文件**
  - **输入**：表结构（来自 2.4.1）
...
- [x] **2.4.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **2.5.3 创建 dt_configs 的 mock 数据文件**
  - **输入**：表结构（来自 2.5.1）
...
- [x] **2.5.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的配置数据（来自 2.5.4）
  - **输出**：格式验证报告
...
- [x] **2.6.1 读取 dt_config_items 表结构**
...
- [x] **2.6.3 创建 dt_config_items 的 mock 数据文件**
  - **输入**：表结构（来自 2.6.1）
...
- [x] **2.6.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **2.7.3 创建 dt_menu_groups 的 mock 数据文件**
  - **输入**：表结构（来自 2.7.1）
...
- [x] **2.7.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **2.8.1 读取 dt_menu_catalogs 表结构**
...
- [x] **2.8.3 创建 dt_menu_catalogs 的 mock 数据文件**
  - **输入**：表结构（来自 2.8.1）
...
- [x] **2.8.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **2.9.3 创建 dt_menu_items 的 mock 数据文件**
  - **输入**：表结构（来自 2.9.1）
...
- [x] **2.9.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **3.1.3 创建 cm_communities 的 mock 数据文件**
  - **输入**：表结构（来自 3.1.1）
...
- [x] **3.1.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的社区数据（来自 3.1.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **3.2.1 读取 cm_building_structures 表结构**
...
- [x] **3.2.3 创建 cm_building_structures 的 mock 数据文件**
  - **输入**：表结构（来自 3.2.1）
...
- [x] **3.2.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的楼栋数据（来自 3.2.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型、外键引用
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **3.3.3 创建 cm_notices 的 mock 数据文件**
  - **输入**：表结构（来自 3.3.1）
...
- [x] **3.3.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的公告数据（来自 3.3.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型、外键引用
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **3.4.1 读取 cm_handing_business 表结构**
...
- [x] **3.4.3 创建 cm_handing_business 的 mock 数据文件**
  - **输入**：表结构（来自 3.4.1）
...
- [x] **3.4.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的业务数据（来自 3.4.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **3.5.1 读取 cm_house_decorations 表结构**
...
- [x] **3.5.3 创建 cm_house_decorations 的 mock 数据文件**
  - **输入**：表结构（来自 3.5.1）
...
- [x] **3.5.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的装修数据（来自 3.5.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **3.6.1 读取 cm_property_registers 表结构**
...
- [x] **3.6.3 创建 cm_property_registers 的 mock 数据文件**
  - **输入**：表结构（来自 3.6.1）
...
- [x] **3.6.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的登记数据（来自 3.6.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **3.7.6 导出 generateCommunitySql 函数**
  - **输入**：所有表的生成逻辑
...
- [x] **4.1.1 读取 sm_organizations 表结构**
...
- [x] **4.1.3 创建 sm_organizations 的 mock 数据文件**
  - **输入**：表结构（来自 4.1.1）
...
- [x] **4.1.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的组织数据（来自 4.1.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **4.2.3 创建 sm_staff 的 mock 数据文件**
  - **输入**：表结构（来自 4.2.1）
...
- [x] **4.2.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的员工数据（来自 4.2.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **4.3.3 创建 sm_roles 的 mock 数据文件**
  - **输入**：表结构（来自 4.3.1）
...
- [x] **4.3.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的角色数据（来自 4.3.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **4.4.3 创建 sm_permissions 的 mock 数据文件**
  - **输入**：表结构（来自 4.4.1）
...
- [x] **4.4.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的权限数据（来自 4.4.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **4.5.1 读取 sm_role_permissions 表结构**
...
- [x] **4.5.3 创建 sm_role_permissions 的 mock 数据文件**
  - **输入**：表结构（来自 4.5.1）
...
- [x] **4.5.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **4.6.3 创建 sm_staff_roles 的 mock 数据文件**
  - **输入**：表结构（来自 4.6.1）
...
- [x] **4.6.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **4.7.1 读取 sm_data_permissions 表结构**
  - **输入**：读取 `apps/type/src/business/setting/data-permission/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **4.7.2 创建 sm_data_permissions 的 mock 数据文件**
  - **输入**：表结构（来自 4.7.1）
...
- [x] **4.7.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **4.8.1 读取 sm_shifts 表结构**
  - **输入**：读取 `apps/type/src/business/setting/shift/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **4.8.2 创建 sm_shifts 的 mock 数据文件**
  - **输入**：表结构（来自 4.8.1）
...
- [x] **4.8.4 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的班次数据（来自 4.8.3）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **4.9.1 读取 sm_scheduling_settings 表结构**
  - **输入**：读取 `apps/type/src/business/setting/scheduling-setting/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **4.9.2 创建 sm_scheduling_settings 的 mock 数据文件**
  - **输入**：表结构（来自 4.9.1）
...
- [x] **4.9.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **4.10.1 读取 sm_working_schedules 表结构**
...
- [x] **4.10.3 创建 sm_working_schedules 的 mock 数据文件**
  - **输入**：表结构（来自 4.10.1）
...
- [x] **4.10.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **4.11.1 读取 sm_system_configs 表结构**
  - **输入**：读取 `apps/type/src/business/setting/system-config/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **4.11.2 创建 sm_system_configs 的 mock 数据文件**
  - **输入**：表结构（来自 4.11.1）
...
- [x] **4.11.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **4.12.1 读取 sm_register_protocols 表结构**
  - **输入**：读取 `apps/type/src/business/setting/register-protocol/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **4.12.2 创建 sm_register_protocols 的 mock 数据文件**
  - **输入**：表结构（来自 4.12.1）
...
- [x] **4.12.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **4.14.1 读取 sm_community_configurations 表结构**
  - **输入**：读取 `apps/type/src/business/setting/community-configuration/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **4.14.2 创建 sm_community_configurations 的 mock 数据文件**
  - **输入**：表结构（来自 4.14.1）
...
- [x] **4.14.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **4.16.9 导出 generateSettingSql 函数**
  - **输入**：所有表的生成逻辑
...
- [x] **5.1.3 创建 hp_houses 的 mock 数据文件**
  - **输入**：表结构（来自 5.1.1）
...
- [x] **5.1.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的房产数据（来自 5.1.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **5.2.3 创建 hp_owners 的 mock 数据文件**
  - **输入**：表结构（来自 5.2.1）
...
- [x] **5.2.5 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的业主数据（来自 5.2.4）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **5.3.1 读取 hp_owner_accounts 表结构**
  - **输入**：读取 `apps/type/src/business/house-property/owner-account/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **5.3.2 创建 hp_owner_accounts 的 mock 数据文件**
  - **输入**：表结构（来自 5.3.1）
...
- [x] **5.3.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **5.4.1 读取 hp_owner_members 表结构**
  - **输入**：读取 `apps/type/src/business/house-property/owner-member/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **5.4.2 创建 hp_owner_members 的 mock 数据文件**
  - **输入**：表结构（来自 5.4.1）
...
- [x] **5.4.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **5.5.1 读取 hp_owners_committees 表结构**
  - **输入**：读取 `apps/type/src/business/house-property/owners-committee/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **5.5.2 创建 hp_owners_committees 的 mock 数据文件**
  - **输入**：表结构（来自 5.5.1）
...
- [x] **5.5.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **5.6.1 读取 hp_invoice_titles 表结构**
  - **输入**：读取 `apps/type/src/business/house-property/invoice-title/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **5.6.2 创建 hp_invoice_titles 的 mock 数据文件**
  - **输入**：表结构（来自 5.6.1）
...
- [x] **5.6.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **5.7.4 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的发票数据（来自 5.7.3）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **5.8.1 读取 hp_reserve_venues 表结构**
  - **输入**：读取 `apps/type/src/business/house-property/reserve-venue/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **5.8.2 创建 hp_reserve_venues 的 mock 数据文件**
  - **输入**：表结构（来自 5.8.1）
...
- [x] **5.8.4 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的场地数据（来自 5.8.3）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **5.9.1 读取 hp_reserve_venue_orders 表结构**
...
- [x] **5.10.1 读取 hp_site_managements 表结构**
  - **输入**：读取 `apps/type/src/business/house-property/site-management/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **5.10.2 创建 hp_site_managements 的 mock 数据文件**
  - **输入**：表结构（来自 5.10.1）
...
- [x] **5.10.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **5.11.7 导出 generateHousePropertySql 函数**
  - **输入**：所有表的生成逻辑
...
- [x] **6.1.1 读取 op_merchants 表结构**
  - **输入**：读取 `apps/type/src/business/operation/merchant/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **6.1.2 创建 op_merchants 的 mock 数据文件**
  - **输入**：表结构（来自 6.1.1）
...
- [x] **6.1.4 验证 mock 数据格式符合 schema 定义**
  - **输入**：完整的商家数据（来自 6.1.3）
  - **输出**：格式验证报告
  - **内容**：检查字段完整性、数据类型
  - **验证**：所有字段符合 Drizzle schema 定义
...
- [x] **6.2.1 读取 op_merchant_admins 表结构**
...
- [x] **6.2.3 创建 op_merchant_admins 的 mock 数据文件**
  - **输入**：表结构（来自 6.2.1）
...
- [x] **6.2.5 验证 mock 数据格式符合 schema 定义**
...
- [x] **6.3.1 读取 op_property_companies 表结构**
  - **输入**：读取 `apps/type/src/business/operation/property-company/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **6.3.2 创建 op_property_companies 的 mock 数据文件**
  - **输入**：表结构（来自 6.3.1）
...
- [x] **6.3.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **6.4.1 读取 op_community_info 表结构**
  - **输入**：读取 `apps/type/src/business/operation/community-info/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **6.4.2 创建 op_community_info 的 mock 数据文件**
  - **输入**：表结构（来自 6.4.1）
...
- [x] **6.4.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **6.5.1 读取 op_community_configs 表结构**
  - **输入**：读取 `apps/type/src/business/operation/community-config/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **6.5.2 创建 op_community_configs 的 mock 数据文件**
  - **输入**：表结构（来自 6.5.1）
...
- [x] **6.5.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **6.6.1 读取 op_register_protocols 表结构**
  - **输入**：读取 `apps/type/src/business/operation/register-protocol/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **6.6.2 创建 op_register_protocols 的 mock 数据文件**
  - **输入**：表结构（来自 6.6.1）
...
- [x] **6.6.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **6.7.1 读取 op_report_groups 表结构**
  - **输入**：读取 `apps/type/src/business/operation/report-group/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **6.7.2 创建 op_report_groups 的 mock 数据文件**
  - **输入**：表结构（来自 6.7.1）
...
- [x] **6.7.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **6.8.1 读取 op_report_components 表结构**
  - **输入**：读取 `apps/type/src/business/operation/report-component/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **6.8.2 创建 op_report_components 的 mock 数据文件**
  - **输入**：表结构（来自 6.8.1）
...
- [x] **6.8.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **6.9.1 读取 op_report_infos 表结构**
  - **输入**：读取 `apps/type/src/business/operation/report-info/schema.ts`
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **6.9.2 创建 op_report_infos 的 mock 数据文件**
  - **输入**：表结构（来自 6.9.1）
...
- [x] **6.9.4 验证 mock 数据格式符合 schema 定义**
...
- [x] **6.10.1 导入所有 operation 模块的 mock 数据**
  - **输入**：所有 operation 模块的 mock-data.ts 文件
  - **输出**：导入语句
  - **内容**：在 seed-sql/04-operation.ts 中导入所有 mock 数据
  - **验证**：无导入错误

- [x] **6.10.2 为 op_merchants 添加生成逻辑**
  - **输入**：mockMerchants 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：生成 INSERT 语句
  - **验证**：生成的 SQL 包含所有商家数据

- [x] **6.10.3 为 op_merchant_admins 添加生成逻辑**
...
- [x] **6.10.5 导出 generateOperationSql 函数**
  - **输入**：所有表的生成逻辑
...
- [x] **7.1.3 创建 ct_types mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.1.4 编写 ct_types 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同类型数据
  - **验证**：数据量符合设计要求

- [x] **7.1.5 验证 ct_types mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.2.3 创建 ct_templates mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.2.4 编写 ct_templates 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同模板数据
  - **验证**：数据量符合设计要求

- [x] **7.2.5 验证 ct_templates mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.3.3 创建 ct_clauses mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.3.4 编写 ct_clauses 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同条款数据
  - **验证**：数据量符合设计要求

- [x] **7.3.5 验证 ct_clauses mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.4.1 读取 ct_first_parties 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **7.4.3 创建 ct_first_parties mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.4.4 编写 ct_first_parties 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的甲方信息数据
  - **验证**：数据量符合设计要求

- [x] **7.4.5 验证 ct_first_parties mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.5.1 读取 ct_second_parties 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **7.5.3 创建 ct_second_parties mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.5.4 编写 ct_second_parties 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的乙方信息数据
  - **验证**：数据量符合设计要求

- [x] **7.5.5 验证 ct_second_parties mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.6.3 创建 ct_contracts mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.6.4 编写 ct_contracts 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同信息数据
  - **验证**：数据量符合设计要求

- [x] **7.6.5 验证 ct_contracts mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.7.3 创建 ct_attachments mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.7.4 编写 ct_attachments 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同附件数据
  - **验证**：数据量符合设计要求

- [x] **7.7.5 验证 ct_attachments mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.8.3 创建 ct_changes mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.8.4 编写 ct_changes 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同变更数据
  - **验证**：数据量符合设计要求

- [x] **7.8.5 验证 ct_changes mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.9.3 创建 ct_reviews mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.9.4 编写 ct_reviews 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同审核数据
  - **验证**：数据量符合设计要求

- [x] **7.9.5 验证 ct_reviews mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.10.1 读取 ct_prints 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **7.10.2 分析合同打印的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解合同打印的业务含义
  - **内容**：了解合同打印内容
  - **验证**：能够说明合同打印用途

- [x] **7.10.3 创建 ct_prints mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.10.4 编写 ct_prints 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同打印数据
  - **验证**：数据量符合设计要求

- [x] **7.10.5 验证 ct_prints mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.11.1 读取 ct_archives 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **7.11.2 分析合同归档的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解合同归档的业务含义
  - **内容**：了解合同归档内容
  - **验证**：能够说明合同归档用途

- [x] **7.11.3 创建 ct_archives mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **7.11.4 编写 ct_archives 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同归档数据
  - **验证**：数据量符合设计要求

- [x] **7.11.5 验证 ct_archives mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **7.12.1 导入所有 contract 模块 mock 数据**
  - **输入**：所有 contract 模块 mock-data.ts 文件
  - **输出**：导入语句
  - **内容**：在 seed-sql/05-contract.ts 中导入所有 mock 数据
  - **验证**：无导入错误

- [x] **7.12.2 添加 ct_types 生成逻辑**
  - **输入**：ct_types mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.3 添加 ct_templates 生成逻辑**
  - **输入**：ct_templates mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.4 添加 ct_clauses 生成逻辑**
  - **输入**：ct_clauses mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.5 添加 ct_first_parties 生成逻辑**
  - **输入**：ct_first_parties mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.6 添加 ct_second_parties 生成逻辑**
  - **输入**：ct_second_parties mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.7 添加 ct_contracts 生成逻辑**
  - **输入**：ct_contracts mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.8 添加 ct_attachments 生成逻辑**
  - **输入**：ct_attachments mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.9 添加 ct_changes 生成逻辑**
  - **输入**：ct_changes mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.10 添加 ct_reviews 生成逻辑**
  - **输入**：ct_reviews mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.11 添加 ct_prints 生成逻辑**
  - **输入**：ct_prints mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **7.12.12 添加 ct_archives 生成逻辑**
...
- [x] **8.1.1 读取 pk_parking_lots 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **8.1.3 创建 pk_parking_lots mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **8.1.4 编写 pk_parking_lots 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的停车场数据
  - **验证**：数据量符合设计要求

- [x] **8.1.5 验证 pk_parking_lots mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **8.2.1 读取 pk_parking_structures 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **8.2.3 创建 pk_parking_structures mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **8.2.4 编写 pk_parking_structures 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的停车区域数据
  - **验证**：数据量符合设计要求

- [x] **8.2.5 验证 pk_parking_structures mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **8.3.3 创建 pk_carports mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **8.3.4 编写 pk_carports 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的车位数据
  - **验证**：数据量符合设计要求

- [x] **8.3.5 验证 pk_carports mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **8.4.1 读取 pk_owner_vehicles 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **8.4.3 创建 pk_owner_vehicles mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **8.4.4 编写 pk_owner_vehicles 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的车主车辆数据
  - **验证**：数据量符合设计要求

- [x] **8.4.5 验证 pk_owner_vehicles mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **8.5.1 读取 pk_carport_applications 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **8.5.3 创建 pk_carport_applications mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **8.5.4 编写 pk_carport_applications 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的车位申请数据
  - **验证**：数据量符合设计要求

- [x] **8.5.5 验证 pk_carport_applications mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **8.6.1 导入所有 parking 模块 mock 数据**
  - **输入**：所有 parking 模块 mock-data.ts 文件
  - **输出**：导入语句
  - **内容**：在 seed-sql/06-parking.ts 中导入所有 mock 数据
  - **验证**：无导入错误

- [x] **8.6.2 添加 pk_parking_lots 生成逻辑**
  - **输入**：pk_parking_lots mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **8.6.3 添加 pk_parking_structures 生成逻辑**
  - **输入**：pk_parking_structures mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **8.6.4 添加 pk_carports 生成逻辑**
  - **输入**：pk_carports mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **8.6.5 添加 pk_owner_vehicles 生成逻辑**
  - **输入**：pk_owner_vehicles mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **8.6.6 添加 pk_carport_applications 生成逻辑**
...
- [x] **9.1.1 读取 ex_expense_items 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **9.1.3 创建 ex_expense_items mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.1.4 编写 ex_expense_items 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的费用项目数据
  - **验证**：数据量符合设计要求

- [x] **9.1.5 验证 ex_expense_items mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.2.1 读取 ex_discount_types 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **9.2.3 创建 ex_discount_types mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.2.4 编写 ex_discount_types 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的优惠类型数据
  - **验证**：数据量符合设计要求

- [x] **9.2.5 验证 ex_discount_types mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.3.1 读取 ex_discount_settings 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **9.3.3 创建 ex_discount_settings mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.3.4 编写 ex_discount_settings 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的优惠设置数据
  - **验证**：数据量符合设计要求

- [x] **9.3.5 验证 ex_discount_settings mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.4.1 读取 ex_meter_reading_types 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **9.4.3 创建 ex_meter_reading_types mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.4.4 编写 ex_meter_reading_types 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的抄表类型数据
  - **验证**：数据量符合设计要求

- [x] **9.4.5 验证 ex_meter_reading_types mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.5.1 读取 ex_contract_charges 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **9.5.3 创建 ex_contract_charges mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.5.4 编写 ex_contract_charges 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的合同费用数据
  - **验证**：数据量符合设计要求

- [x] **9.5.5 验证 ex_contract_charges mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.6.1 读取 ex_house_charges 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **9.6.3 创建 ex_house_charges mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.6.4 编写 ex_house_charges 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的房产费用数据
  - **验证**：数据量符合设计要求

- [x] **9.6.5 验证 ex_house_charges mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.7.1 读取 ex_vehicle_charges 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **9.7.3 创建 ex_vehicle_charges mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.7.4 编写 ex_vehicle_charges 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的车辆费用数据
  - **验证**：数据量符合设计要求

- [x] **9.7.5 验证 ex_vehicle_charges mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.8.1 读取 ex_meter_readings 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **9.8.3 创建 ex_meter_readings mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.8.4 编写 ex_meter_readings 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的抄表记录数据
  - **验证**：数据量符合设计要求

- [x] **9.8.5 验证 ex_meter_readings mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.9.3 创建 ex_payments mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.9.4 编写 ex_payments 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的缴费记录数据
  - **验证**：数据量符合设计要求

- [x] **9.9.5 验证 ex_payments mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.10.1 读取 ex_payment_reviews 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **9.10.2 分析缴费审核的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解缴费审核的业务含义
  - **内容**：了解缴费审核信息
  - **验证**：能够说明缴费审核用途

- [x] **9.10.3 创建 ex_payment_reviews mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.10.4 编写 ex_payment_reviews 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的缴费审核数据
  - **验证**：数据量符合设计要求

- [x] **9.10.5 验证 ex_payment_reviews mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.11.1 读取 ex_discount_applications 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **9.11.2 分析优惠申请的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解优惠申请的业务含义
  - **内容**：了解优惠申请信息
  - **验证**：能够说明优惠申请用途

- [x] **9.11.3 创建 ex_discount_applications mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.11.4 编写 ex_discount_applications 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的优惠申请数据
  - **验证**：数据量符合设计要求

- [x] **9.11.5 验证 ex_discount_applications mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.12.1 读取 ex_cancel_fees 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **9.12.2 分析退费记录的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解退费记录的业务含义
  - **内容**：了解退费记录信息
  - **验证**：能够说明退费记录用途

- [x] **9.12.3 创建 ex_cancel_fees mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.12.4 编写 ex_cancel_fees 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的退费记录数据
  - **验证**：数据量符合设计要求

- [x] **9.12.5 验证 ex_cancel_fees mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.13.1 读取 ex_refund_reviews 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **9.13.2 分析退款审核的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解退款审核的业务含义
  - **内容**：了解退款审核信息
  - **验证**：能够说明退款审核用途

- [x] **9.13.3 创建 ex_refund_reviews mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.13.4 编写 ex_refund_reviews 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的退款审核数据
  - **验证**：数据量符合设计要求

- [x] **9.13.5 验证 ex_refund_reviews mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.14.1 读取 ex_overdue_reminders 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **9.14.2 分析催缴提醒的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解催缴提醒的业务含义
  - **内容**：了解催缴提醒信息
  - **验证**：能够说明催缴提醒用途

- [x] **9.14.3 创建 ex_overdue_reminders mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.14.4 编写 ex_overdue_reminders 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的催缴提醒数据
  - **验证**：数据量符合设计要求

- [x] **9.14.5 验证 ex_overdue_reminders mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.15.1 读取 ex_reprint_vouchers 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **9.15.2 分析补打凭证的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解补打凭证的业务含义
  - **内容**：了解补打凭证信息
  - **验证**：能够说明补打凭证用途

- [x] **9.15.3 创建 ex_reprint_vouchers mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.15.4 编写 ex_reprint_vouchers 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的补打凭证数据
  - **验证**：数据量符合设计要求

- [x] **9.15.5 验证 ex_reprint_vouchers mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.16.1 读取 ex_expense_summary_tables 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **9.16.2 分析费用汇总表的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解费用汇总表的业务含义
  - **内容**：了解费用汇总表信息
  - **验证**：能够说明费用汇总表用途

- [x] **9.16.3 创建 ex_expense_summary_tables mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **9.16.4 编写 ex_expense_summary_tables 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的费用汇总表数据
  - **验证**：数据量符合设计要求

- [x] **9.16.5 验证 ex_expense_summary_tables mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **9.17.1 导入所有 expense 模块 mock 数据**
  - **输入**：所有 expense 模块 mock-data.ts 文件
  - **输出**：导入语句
  - **内容**：在 seed-sql/07-expense.ts 中导入所有 mock 数据
  - **验证**：无导入错误

- [x] **9.17.2 添加 ex_expense_items 生成逻辑**
  - **输入**：ex_expense_items mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.3 添加 ex_discount_types 生成逻辑**
  - **输入**：ex_discount_types mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.4 添加 ex_discount_settings 生成逻辑**
  - **输入**：ex_discount_settings mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.5 添加 ex_meter_reading_types 生成逻辑**
  - **输入**：ex_meter_reading_types mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.6 添加 ex_contract_charges 生成逻辑**
  - **输入**：ex_contract_charges mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.7 添加 ex_house_charges 生成逻辑**
  - **输入**：ex_house_charges mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.8 添加 ex_vehicle_charges 生成逻辑**
  - **输入**：ex_vehicle_charges mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.9 添加 ex_meter_readings 生成逻辑**
  - **输入**：ex_meter_readings mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.10 添加 ex_payments 生成逻辑**
  - **输入**：ex_payments mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.11 添加 ex_payment_reviews 生成逻辑**
  - **输入**：ex_payment_reviews mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.12 添加 ex_discount_applications 生成逻辑**
  - **输入**：ex_discount_applications mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.13 添加 ex_cancel_fees 生成逻辑**
  - **输入**：ex_cancel_fees mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.14 添加 ex_refund_reviews 生成逻辑**
  - **输入**：ex_refund_reviews mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.15 添加 ex_overdue_reminders 生成逻辑**
  - **输入**：ex_overdue_reminders mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.16 添加 ex_reprint_vouchers 生成逻辑**
  - **输入**：ex_reprint_vouchers mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **9.17.17 添加 ex_expense_summary_tables 生成逻辑**
...
- [x] **10.1.1 读取 pt_patrol_points 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段
...
- [x] **10.1.3 创建 pt_patrol_points mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **10.1.4 编写 pt_patrol_points 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的巡检点数据
  - **验证**：数据量符合设计要求

- [x] **10.1.5 验证 pt_patrol_points mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **10.2.1 读取 pt_patrol_paths 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **10.2.2 分析巡检路线的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解巡检路线的业务含义
  - **内容**：了解巡检路线信息
  - **验证**：能够说明巡检路线用途

- [x] **10.2.3 创建 pt_patrol_paths mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **10.2.4 编写 pt_patrol_paths 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的巡检路线数据
  - **验证**：数据量符合设计要求

- [x] **10.2.5 验证 pt_patrol_paths mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **10.3.1 读取 pt_patrol_items 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **10.3.2 分析巡检项目的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解巡检项目的业务含义
  - **内容**：了解巡检项目信息
  - **验证**：能够说明巡检项目用途

- [x] **10.3.3 创建 pt_patrol_items mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **10.3.4 编写 pt_patrol_items 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的巡检项目数据
  - **验证**：数据量符合设计要求

- [x] **10.3.5 验证 pt_patrol_items mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **10.4.1 读取 pt_patrol_plans 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **10.4.2 分析巡检计划的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解巡检计划的业务含义
  - **内容**：了解巡检计划信息
  - **验证**：能够说明巡检计划用途

- [x] **10.4.3 创建 pt_patrol_plans mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **10.4.4 编写 pt_patrol_plans 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的巡检计划数据
  - **验证**：数据量符合设计要求

- [x] **10.4.5 验证 pt_patrol_plans mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **10.5.1 读取 pt_patrol_tasks 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **10.5.2 分析巡检任务的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解巡检任务的业务含义
  - **内容**：了解巡检任务信息
  - **验证**：能够说明巡检任务用途

- [x] **10.5.3 创建 pt_patrol_tasks mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **10.5.4 编写 pt_patrol_tasks 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的巡检任务数据
  - **验证**：数据量符合设计要求

- [x] **10.5.5 验证 pt_patrol_tasks mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **10.6.1 读取 pt_patrol_task_details 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **10.6.2 分析巡检任务详情的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解巡检任务详情的业务含义
  - **内容**：了解巡检任务详情信息
  - **验证**：能够说明巡检任务详情用途

- [x] **10.6.3 创建 pt_patrol_task_details mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **10.6.4 编写 pt_patrol_task_details 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的巡检任务详情数据
  - **验证**：数据量符合设计要求

- [x] **10.6.5 验证 pt_patrol_task_details mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **10.7.1 导入所有 patrol 模块 mock 数据**
  - **输入**：所有 patrol 模块 mock-data.ts 文件
  - **输出**：导入语句
  - **内容**：在 seed-sql/08-patrol.ts 中导入所有 mock 数据
  - **验证**：无导入错误

- [x] **10.7.2 添加 pt_patrol_points 生成逻辑**
  - **输入**：pt_patrol_points mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **10.7.3 添加 pt_patrol_paths 生成逻辑**
  - **输入**：pt_patrol_paths mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **10.7.4 添加 pt_patrol_items 生成逻辑**
  - **输入**：pt_patrol_items mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **10.7.5 添加 pt_patrol_plans 生成逻辑**
  - **输入**：pt_patrol_plans mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **10.7.6 添加 pt_patrol_tasks 生成逻辑**
  - **输入**：pt_patrol_tasks mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **10.7.7 添加 pt_patrol_task_details 生成逻辑**
...
- [x] **11.1.1 读取 rp_repair_types 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **11.1.2 分析报修类型的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解报修类型的业务含义
  - **内容**：了解报修类型信息
  - **验证**：能够说明报修类型用途

- [x] **11.1.3 创建 rp_repair_types mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **11.1.4 编写 rp_repair_types 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的报修类型数据
  - **验证**：数据量符合设计要求

- [x] **11.1.5 验证 rp_repair_types mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **11.2.1 读取 rp_repair_settings 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **11.2.2 分析报修设置的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解报修设置的业
...
- [x] **12.1.1 读取 rpt_data_statistics 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.1.2 分析数据统计的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解数据统计的业务含义
  - **内容**：了解数据统计信息
  - **验证**：能够说明数据统计用途

- [x] **12.1.3 创建 rpt_data_statistics mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.1.4 编写 rpt_data_statistics 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的数据统计数据
  - **验证**：数据量符合设计要求

- [x] **12.1.5 验证 rpt_data_statistics mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.2.1 读取 rpt_expense_summaries 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.2.2 分析费用汇总的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解费用汇总的业务含义
  - **内容**：了解费用汇总信息
  - **验证**：能够说明费用汇总用途

- [x] **12.2.3 创建 rpt_expense_summaries mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.2.4 编写 rpt_expense_summaries 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的费用汇总数据
  - **验证**：数据量符合设计要求

- [x] **12.2.5 验证 rpt_expense_summaries mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.3.1 读取 rpt_statement_expenses 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.3.2 分析账单费用的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解账单费用的业务含义
  - **内容**：了解账单费用信息
  - **验证**：能够说明账单费用用途

- [x] **12.3.3 创建 rpt_statement_expenses mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.3.4 编写 rpt_statement_expenses 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的账单费用数据
  - **验证**：数据量符合设计要求

- [x] **12.3.5 验证 rpt_statement_expenses mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.4.1 读取 rpt_payment_details 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.4.2 分析缴费明细的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解缴费明细的业务含义
  - **内容**：了解缴费明细信息
  - **验证**：能够说明缴费明细用途

- [x] **12.4.3 创建 rpt_payment_details mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.4.4 编写 rpt_payment_details 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的缴费明细数据
  - **验证**：数据量符合设计要求

- [x] **12.4.5 验证 rpt_payment_details mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.5.1 读取 rpt_owner_payment_details 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.5.2 分析业主缴费明细的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解业主缴费明细的业务含义
  - **内容**：了解业主缴费明细信息
  - **验证**：能够说明业主缴费明细用途

- [x] **12.5.3 创建 rpt_owner_payment_details mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.5.4 编写 rpt_owner_payment_details 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的业主缴费明细数据
  - **验证**：数据量符合设计要求

- [x] **12.5.5 验证 rpt_owner_payment_details mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.6.1 读取 rpt_deposit_reports 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.6.2 分析押金报表的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解押金报表的业务含义
  - **内容**：了解押金报表信息
  - **验证**：能够说明押金报表用途

- [x] **12.6.3 创建 rpt_deposit_reports mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.6.4 编写 rpt_deposit_reports 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的押金报表数据
  - **验证**：数据量符合设计要求

- [x] **12.6.5 验证 rpt_deposit_reports mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.7.1 读取 rpt_outstanding_fees 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.7.2 分析欠费报表的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解欠费报表的业务含义
  - **内容**：了解欠费报表信息
  - **验证**：能够说明欠费报表用途

- [x] **12.7.3 创建 rpt_outstanding_fees mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.7.4 编写 rpt_outstanding_fees 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的欠费报表数据
  - **验证**：数据量符合设计要求

- [x] **12.7.5 验证 rpt_outstanding_fees mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.8.1 读取 rpt_no_charge_houses 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.8.2 分析未收费房屋的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解未收费房屋的业务含义
  - **内容**：了解未收费房屋信息
  - **验证**：能够说明未收费房屋用途

- [x] **12.8.3 创建 rpt_no_charge_houses mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.8.4 编写 rpt_no_charge_houses 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的未收费房屋数据
  - **验证**：数据量符合设计要求

- [x] **12.8.5 验证 rpt_no_charge_houses mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.9.1 读取 rpt_fee_reminders 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.9.2 分析费用提醒的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解费用提醒的业务含义
  - **内容**：了解费用提醒信息
  - **验证**：能够说明费用提醒用途

- [x] **12.9.3 创建 rpt_fee_reminders mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.9.4 编写 rpt_fee_reminders 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的费用提醒数据
  - **验证**：数据量符合设计要求

- [x] **12.9.5 验证 rpt_fee_reminders mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.10.1 读取 rpt_repair_reports 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.10.2 分析报修报表的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解报修报表的业务含义
  - **内容**：了解报修报表信息
  - **验证**：能够说明报修报表用途

- [x] **12.10.3 创建 rpt_repair_reports mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.10.4 编写 rpt_repair_reports 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的报修报表数据
  - **验证**：数据量符合设计要求

- [x] **12.10.5 验证 rpt_repair_reports mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.11.1 读取 rpt_repair_summaries 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.11.2 分析报修汇总的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解报修汇总的业务含义
  - **内容**：了解报修汇总信息
  - **验证**：能够说明报修汇总用途

- [x] **12.11.3 创建 rpt_repair_summaries mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.11.4 编写 rpt_repair_summaries 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的报修汇总数据
  - **验证**：数据量符合设计要求

- [x] **12.11.5 验证 rpt_repair_summaries mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.12.1 读取 rpt_patrol_reports 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **12.12.2 分析巡检报表的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解巡检报表的业务含义
  - **内容**：了解巡检报表信息
  - **验证**：能够说明巡检报表用途

- [x] **12.12.3 创建 rpt_patrol_reports mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **12.12.4 编写 rpt_patrol_reports 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的巡检报表数据
  - **验证**：数据量符合设计要求

- [x] **12.12.5 验证 rpt_patrol_reports mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **12.13.1 导入所有 report 模块 mock 数据**
  - **输入**：所有 report 模块 mock-data.ts 文件
  - **输出**：导入语句
  - **内容**：在 seed-sql/10-report.ts 中导入所有 mock 数据
  - **验证**：无导入错误

- [x] **12.13.2 添加 rpt_data_statistics 生成逻辑**
  - **输入**：rpt_data_statistics mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.3 添加 rpt_expense_summaries 生成逻辑**
  - **输入**：rpt_expense_summaries mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.4 添加 rpt_statement_expenses 生成逻辑**
  - **输入**：rpt_statement_expenses mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.5 添加 rpt_payment_details 生成逻辑**
  - **输入**：rpt_payment_details mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.6 添加 rpt_owner_payment_details 生成逻辑**
  - **输入**：rpt_owner_payment_details mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.7 添加 rpt_deposit_reports 生成逻辑**
  - **输入**：rpt_deposit_reports mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.8 添加 rpt_outstanding_fees 生成逻辑**
  - **输入**：rpt_outstanding_fees mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.9 添加 rpt_no_charge_houses 生成逻辑**
  - **输入**：rpt_no_charge_houses mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.10 添加 rpt_fee_reminders 生成逻辑**
  - **输入**：rpt_fee_reminders mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.11 添加 rpt_repair_reports 生成逻辑**
  - **输入**：rpt_repair_reports mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.12 添加 rpt_repair_summaries 生成逻辑**
  - **输入**：rpt_repair_summaries mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **12.13.13 添加 rpt_patrol_reports 生成逻辑**
...
- [x] **13.1.1 读取 auth_roles 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **13.1.2 分析认证角色的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解认证角色的业务含义
  - **内容**：了解认证角色信息
  - **验证**：能够说明认证角色用途

- [x] **13.1.3 创建 auth_roles mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **13.1.4 编写 auth_roles 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的认证角色数据
  - **验证**：数据量符合设计要求

- [x] **13.1.5 验证 auth_roles mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性
  - **验证**：所有字段符合 schema 定义
...
- [x] **13.2.1 读取 auth_user_mapping 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **13.2.2 分析用户映射的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解用户映射的业务含义
  - **内容**：了解用户映射信息
  - **验证**：能够说明用户映射用途

- [x] **13.2.3 创建 auth_user_mapping mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **13.2.4 编写 auth_user_mapping 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的用户映射数据
  - **验证**：数据量符合设计要求

- [x] **13.2.5 验证 auth_user_mapping mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **13.3.1 读取 auth_user_roles 表结构**
  - **输入**：读取 schema 文件
  - **输出**：理解表字段定义
  - **内容**：分析 Drizzle 表定义
  - **验证**：能够列出所有字段

- [x] **13.3.2 分析用户角色的业务场景**
  - **输入**：参考现有 mock 数据
  - **输出**：理解用户角色的业务含义
  - **内容**：了解用户角色信息
  - **验证**：能够说明用户角色用途

- [x] **13.3.3 创建 auth_user_roles mock 数据文件**
  - **输入**：表结构和业务场景
  - **输出**：创建 mock 数据文件
  - **内容**：编写 mock 数据数组
  - **验证**：文件存在且包含数据

- [x] **13.3.4 编写 auth_user_roles 数据内容**
  - **输入**：mock 数据文件
  - **输出**：完整的 mock 数据
  - **内容**：编写具体的用户角色数据
  - **验证**：数据量符合设计要求

- [x] **13.3.5 验证 auth_user_roles mock 数据格式**
  - **输入**：完整的 mock 数据
  - **输出**：验证报告
  - **内容**：检查字段完整性和外键关联
  - **验证**：所有字段符合 schema 定义
...
- [x] **13.4.1 导入认证模块 mock 数据**
  - **输入**：所有认证模块 mock-data.ts 文件
  - **输出**：导入语句
  - **内容**：在 seed-sql 认证模块中导入所有 mock 数据
  - **验证**：无导入错误

- [x] **13.4.2 添加 auth_roles 生成逻辑**
  - **输入**：auth_roles mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **13.4.3 添加 auth_user_mapping 生成逻辑**
  - **输入**：auth_user_mapping mock 数据
  - **输出**：INSERT SQL 生成逻辑
  - **内容**：使用 IdMapRegistry.register() 注册 ID，生成 SQL
  - **验证**：生成的 SQL 语句正确

- [x] **13.4.4 添加 auth_user_roles 生成逻辑**
...
- [x] **13.5.1 运行认证模块 SQL 生成命令**
  - **输入**：seed-sql 认证模块
  - **输出**：生成的 SQL 文件
  - **内容**：运行 `pnpm run generate-seed-sql --module auth`
  - **验证**：命令执行成功，无错误

- [x] **13.5.2 检查生成的 SQL 内容**
  - **输入**：生成的 SQL 文件
  - **输出**：SQL 内容分析报告
