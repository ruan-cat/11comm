# [LEGACY/ARCHIVED] Nitro API Specification (Mock Data)

> **WARNING: THIS SPEC IS DEPRECATED AND ARCHIVED.**
>
> This specification describes the legacy Mock Data pattern for Nitro APIs.
> New development must follow the Drizzle ORM pattern described in `openspec/specs/nitro-api/spec.md` (via the `use-nitro` skill).
>
> This file is preserved for reference when maintaining legacy interfaces that have not yet been migrated to the database.
